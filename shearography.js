...
const inspections = [
  ...
  { casing:'XT106162', date:'28/06/2025 08:28', serial:'010A210470', pattern:'VIKING 3', service:'Repair', retreadDesign:'BREMELS - VIKING 3', comments:'' },
  ...
  { casing:'XT106318', date:'01/07/2025 06:56', serial:'PFK17145', pattern:'RZM530L', service:'Claim', retreadDesign:'RUZI - RZM530L', comments:'' },
  ...
  list.innerHTML += `
    <div class="inspection-card">
      <div class="row align-items-center">
        ...
        <div class="col"><small>Product Code</small><div>${item.pattern}</div></div>
        <div class="col"><small>Service Type</small><div>${item.service}</div></div>
